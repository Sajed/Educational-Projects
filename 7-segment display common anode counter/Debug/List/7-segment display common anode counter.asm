...
_0x3:
	.DB  0x6,0x0,0x5B,0x0,0x4F,0x0,0x66,0x0
	.DB  0x6D,0x0,0x7C,0x0,0x7,0x0,0x7F
...
;/*****************************************************
;
; © Copyright 2014 Sajed RasouliFar
; http://www.freeterminal.ir
;
...
;#include <delay.h>
;int i;
;int c[8]={0X06,0X5B,0X4F,0X66,0X6D,0X7C,0X07,0X7F};

	.DSEG
;flash char a[8]={0X01,0X02,0X04,0X08,0X10,0X20,0X40,0X80};
